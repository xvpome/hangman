...
class BankAccount:
    ...
    def send(self):
        ...
        yourAccount = int(input("Enter your account iban "))
        if yourAccount != self.account_number:
            print("Your iban is invalid")
            
        else:
            
            otherAccount = int(input("Enter recepient's iban "))
            moneySend = True
            
            while moneySend is True:
                ...
                if money > self.balance:
                    ...
                    print("Not enough money in balance")
                     ...
                     self.balance = self.balance - money
                     print(f"Sucessfully sent {money}$ to {otherAccount}")
                     moneySend = False
                     break
